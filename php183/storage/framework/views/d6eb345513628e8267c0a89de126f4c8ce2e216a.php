	...
	<meta http-equiv="x-ua-compatible" content="IE=edge,chrome=1" />	<meta name="renderer" content="webkit">
		...
		<body>
			...
			<h1>		
				...
				<form  action="<?php echo e(url('/home/sign/insert')); ?>" method="post">		
				 ...
				 <?php if(session('info')): ?>
   				 ...
   				 <?php endif; ?>
				<div class="item">				
					<input type="text" name="name" value="<?php echo e(old('name')); ?>"  class="ui-input password" placeholder="请输入用户名">	
				</div>	
				<div class="item">				
					<input type="password" name="password1" value="<?php echo e(old('password1')); ?>"  class="ui-input password" placeholder="确认密码">		
				</div>			
				<div class="item">				
					<input type="password" name="password" value="<?php echo e(old('password')); ?>" class="ui-input password" placeholder="密码">		
				</div>			
				<div class="item">				
