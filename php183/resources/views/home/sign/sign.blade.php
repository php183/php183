...
<link rel="dns-prefetch" href="//s11.mogucdn.com/">	<link rel="dns-prefetch" href="//s16.mogucdn.com/">
	...
	<meta http-equiv="x-ua-compatible" content="IE=edge,chrome=1" />	<meta name="renderer" content="webkit">
		...
		<link type="text/css" rel="stylesheet" href="{{ asset('/home/Css/base-2bac77b294.css') }}">	
		<link type="text/css" rel="stylesheet" href="{{ asset('/home/Css/login-d50f226da3.css') }}">	
		<script type="text/javascript" src="{{ asset('/home/Scripts/170425_88i053fl0id9k0a63lfhkdaf9g991.js') }}"><!-- fml.js --></script>	
		...
		<script type="text/javascript" src="{{ asset('/home/Scripts/index.min.js') }}"><!-- 设备指纹 -->
		</script>
		<body>
			<div class="page">	
			<h1>		
				<span><img src="{{ asset('/home/Images/170608_4abia54942c229cgg69f073b9g23d_408x104.png') }}"> <font color="pink">嗨易购</font></span>
			</h1>
				<div class="content">					
				<div class="left-box">	
				<h2><font color="pink">嗨易购 一家专门做特卖的网站</font></h2><br/>

					<img src="{{ asset('/home/Picture/idid_ifrgmmjqmnsgmmbvmizdambqmeyde_370x353.jpg') }}" alt="">
				</div>
				<div class="right-box">	
				<p class="title">	
					新用户注册		
